...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(x => x.text.contains(google))
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(x => x.text.contains(apple))
